...
export const getServerSideProps = async (context) => {
    ...
    const response = await fetch(`https://newsapi.org/v2/everything?q=${params.pages[0]}&q=india&from=${Date.now()-1}&sortBy=publishedAt&apiKey=4b8ba1584d8746f8b21d076444d7e604`);
